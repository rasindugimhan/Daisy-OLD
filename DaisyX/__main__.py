...
PM_START_TEXT = """
Hello there, I'm [ShizuBot](https://telegra.ph/file/4838fb76ee046eb4c3161.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add ShizuBot to your group 💫", url="t.me/MrRGYT_music_bot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/4838fb76ee046eb4c3161.jpg)
...
Support them  [Rasiya](t.me/Mr_Rasiyaa),[Gimhan](t.me/Mr_Rasiyaa),"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [Channel](https://t.me/Mr_RG_YT) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/4838fb76ee046eb4c3161.jpg)"
